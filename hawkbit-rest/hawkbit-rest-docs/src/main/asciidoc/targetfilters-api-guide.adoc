...
Handles the POST request to create a new target filter query within SP.
...
Handles the DELETE request of deleting a target filter query within SP.
...
Handles the GET request of retrieving a single target filter query within SP.
Required permission: READ_TARGET
...
Handles the PUT request of updating a target filter query within SP.
...
Handles the GET request of retrieving the auto assign distribution set.
Required permission: READ_TARGET
...
Removes the auto assign distribution set from the target filter query.
Required permission: UPDATE_TARGET
...
== POST /rest/v1/targetfilters/{targetFilterQueryId}/autoAssign/pause

=== Implementation Notes

Pauses the auto assignment of a target filter query.
Required permission: UPDATE_TARGET

=== Pausing the auto assignment

==== Curl

include::{snippets}/targetfilters/post-auto-assign-pause/curl-request.adoc[]

==== Request URL

include::{snippets}/targetfilters/post-auto-assign-pause/http-request.adoc[]

==== Request path parameter

include::{snippets}/targetfilters/post-auto-assign-pause/path-parameters.adoc[]

=== Response (Status 200)

==== Response example

include::{snippets}/targetfilters/post-auto-assign-pause/http-response.adoc[]
...
== POST /rest/v1/targetfilters/{targetFilterQueryId}/autoAssign/start

=== Implementation Notes

Starts the paused auto assignment of a target filter query.
Required permission: UPDATE_TARGET

=== Starts the paused auto assignment

==== Curl

include::{snippets}/targetfilters/post-auto-assign-start/curl-request.adoc[]

==== Request URL

include::{snippets}/targetfilters/post-auto-assign-start/http-request.adoc[]

==== Request path parameter

include::{snippets}/targetfilters/post-auto-assign-start/path-parameters.adoc[]

=== Response (Status 200)

==== Response example

include::{snippets}/targetfilters/post-auto-assign-start/http-response.adoc[]
