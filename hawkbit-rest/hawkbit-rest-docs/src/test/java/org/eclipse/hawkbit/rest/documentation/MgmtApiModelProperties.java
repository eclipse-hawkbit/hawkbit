...
public final class MgmtApiModelProperties {
    ...
    public static final String ROLLOUT_WEIGHT = "Priority of the resulting Actions";
    ...
    public static final String ACTION_WEIGHT = "Priority of the action.";
    ...
    public static final String WEIGHT = "Priority of the assignment.";
