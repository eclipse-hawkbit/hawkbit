...
public class RestConfiguration {
    ...
    public static class ResponseExceptionHandler {
        ...
        static {
            ...
            ERROR_TO_HTTP_STATUS.put(SpServerError.SP_ACTION_NOT_DELETABLE, METHOD_NOT_ALLOWED);
            ...
            ERROR_TO_HTTP_STATUS.put(SpServerError.SP_AUTO_ASSIGNMENT_ILLEGAL_STATE, CONFLICT);
