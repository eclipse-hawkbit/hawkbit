...
public class MgmtRolloutResource implements MgmtRolloutRestApi {
    ...
    @Override
    @AuditLog(entity = "Rollout", message = "Start Rollout")
    ...
    @Override
    @AuditLog(entity = "Rollout", message = "Pause Rollout")
    ...
    @Override
    @AuditLog(entity = "Rollout", message = "Delete Rollout")
    ...
    @Override
    @AuditLog(entity = "Rollout", message = "Resume Rollout")
    ...
    @Override
    @AuditLog(entity = "Rollout", message = "Trigger Next Rollout Group")
