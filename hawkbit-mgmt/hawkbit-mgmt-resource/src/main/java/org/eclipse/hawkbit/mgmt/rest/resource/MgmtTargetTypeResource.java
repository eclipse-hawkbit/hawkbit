...
public class MgmtTargetTypeResource implements MgmtTargetTypeRestApi {
    ...
    @Override
    @AuditLog(entity = "TargetType", message = "Delete Target Type")
    ...
    @Override
    @AuditLog(entity = "TargetType", message = "Remove Compatible Distribution Set From Target Type")
    ...
    @Override
    @AuditLog(entity = "TargetType", message = "Add Compatible Distribution Set To Target Type")
