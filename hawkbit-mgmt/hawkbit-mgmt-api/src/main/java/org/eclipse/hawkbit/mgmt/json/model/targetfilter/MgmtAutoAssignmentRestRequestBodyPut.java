...
/**
 * Model for requests containing an auto assignment body e.g. in a PUT request
 * of updating an auto assignment via REST API
 */
@Data
...
public class MgmtAutoAssignmentRestRequestBodyPut {
