...
public class HawkbitMcpToolProvider {
    ...
    @McpTool(name = "list_targets", description = """
            Retrieves a paged list of targets (devices) with optional RSQL filtering. \
    ...
    @McpTool(name = "list_rollouts", description = """
            Retrieves a paged list of rollouts with optional RSQL filtering. \
    ...
    @McpTool(name = "list_distribution_sets", description = """
            Retrieves a paged list of distribution sets with optional RSQL filtering. \
    ...
    @McpTool(name = "list_actions", description = """
            Retrieves a paged list of actions with optional RSQL filtering. \
    ...
    @McpTool(name = "list_software_modules", description = """
            Retrieves a paged list of software modules with optional RSQL filtering. \
    ...
    @McpTool(name = "list_target_filters", description = """
            Retrieves a paged list of target filter queries with optional RSQL filtering. \
    ...
    @McpTool(name = "manage_target", description = """
            Create, update, or delete targets (devices). \
            Operations: CREATE (new target with controllerId, name, description. \
            When creating a target without a specific target type, set "targetType": null), \
            UPDATE (modify existing target by controllerId), \
            DELETE (remove target by controllerId). \
            Use 'type' field to select operation:
            {
              "type": "Create",
              "body": { "controllerId": "id", "name": "name" }
            }
            {
              "type": "Update",
              "controllerId": "id",
    ...
    @McpTool(name = "manage_rollout", description = """
            Create, update, delete, and control rollouts for software deployment. \
            Use 'type' field to select operation. \
    ...
    @McpTool(name = "manage_distribution_set", description = """
            Create, update, or delete distribution sets (software packages). \
            Use 'type' field to select operation:
            {
              "type": "Create",
              "body": { "name": "n", "version": "v", "type": "t" }
            }
            {
              "type": "Update",
              "distributionSetId": 123,
              "body": { ... }
            }
            {
              "type": "Delete",
    ...
    @McpTool(name = "manage_action", description = """
            Delete deployment actions. Actions are created indirectly via distribution set assignment. \
            Use 'type' field to select operation:
            {
              "type": "Delete",
              "actionIds": [123]
    ...
    @McpTool(name = "manage_software_module", description = """
            Create, update, or delete software modules. \
            Use 'type' field to select operation:
            {
              "type": "Create",
              "body": { "name": "n", "version": "v", "type": "t" }
    ...
    @McpTool(name = "manage_target_filter", description = """
            Create, update, or delete target filter queries. \
            Use 'type' field to select operation:
            {
              "type": "Create",
              "body": { "name": "n", "query": "name==*" }
            }
            {
              "type": "Update",
              "filterId": 123,
