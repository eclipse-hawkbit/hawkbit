...
public class MgmtSoftwareModuleTypeResourceTest extends AbstractRestIntegrationTest {
    ...
    private SoftwareModuleType createTestType() {
        SoftwareModuleType testType = softwareManagement.createSoftwareModuleType(
                entityFactory.generateSoftwareModuleType("test123", "TestName123", "Desc123", null, 5));
        testType = softwareManagement.updateSoftwareModuleType(testType.getId(), "Desc1234", null);
        return testType;
    }
    ...
    public void createSoftwareModuleTypesInvalidAssignmentBadRequest() throws JSONException, Exception {
        ...
        types.add(entityFactory.generateSoftwareModuleType("test-1", "TestName-1", "Desc-1", "col-1", -1));
        ...
        types.clear();
        types.add(entityFactory.generateSoftwareModuleType("test0", "TestName0", "Desc0", "col0", 0));
    ...
    public void createSoftwareModuleTypes() throws JSONException, Exception {
        ...
        final List<SoftwareModuleType> types = new ArrayList<>();
        types.add(entityFactory.generateSoftwareModuleType("test1", "TestName1", "Desc1", "col1", 1));
        types.add(entityFactory.generateSoftwareModuleType("test2", "TestName2", "Desc2", "col2", 2));
        types.add(entityFactory.generateSoftwareModuleType("test3", "TestName3", "Desc3", "col3", 3));
    ...
    public void deleteSoftwareModuleTypeUnused() throws Exception {
        final SoftwareModuleType testType = softwareManagement.createSoftwareModuleType(
                entityFactory.generateSoftwareModuleType("test123", "TestName123", "Desc123", "col", 5));
    ...
    public void invalidRequestsOnSoftwaremoduleTypesResource() throws Exception {
        ...
        final SoftwareModuleType toLongName = entityFactory.generateSoftwareModuleType("test123",
                RandomStringUtils.randomAscii(80), "Desc123", "col", 5);
        mvc.perform(post("/rest/v1/softwaremoduletypes")
    ...
    public void searchSoftwareModuleTypeRsql() throws Exception {
        ...
        final SoftwareModuleType testType2 = softwareManagement.createSoftwareModuleType(
                entityFactory.generateSoftwareModuleType("test1234", "TestName1234", "Desc123", "col", 5));
