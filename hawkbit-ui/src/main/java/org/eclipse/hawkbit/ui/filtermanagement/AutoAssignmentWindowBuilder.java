...
public class AutoAssignmentWindowBuilder extends AbstractEntityWindowBuilder<ProxyTargetFilterQuery> {
     ...
     */
    public AutoAssignmentWindowBuilder(final UIConfiguration uiConfig, final TargetManagement targetManagement,
    ...
    public Window getWindowForAutoAssignment(final ProxyTargetFilterQuery proxyTargetFilter) {
        return getWindowForEntity(proxyTargetFilter, new AutoAssignmentWindowController(uiConfig, targetManagement,
