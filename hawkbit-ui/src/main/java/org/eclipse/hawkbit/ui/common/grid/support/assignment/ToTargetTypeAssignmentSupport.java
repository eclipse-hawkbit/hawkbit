 ...
 */
public abstract class ToTargetTypeAssignmentSupport<T, R extends NamedEntity> extends AssignmentSupport<T, ProxyTargetType> {

    protected ToTargetTypeAssignmentSupport(final UINotification notification, final VaadinMessageSource i18n) {
