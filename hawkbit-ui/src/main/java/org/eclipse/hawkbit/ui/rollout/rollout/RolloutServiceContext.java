...
public class RolloutServiceContext {
    ...
    public RolloutServiceContext(RolloutManagement rolloutManagement, RolloutGroupManagement rolloutGroupManagement,
            TargetManagement targetManagement, TargetQueryExecutionManagement targetQueryExecutionManagement, EntityFactory entityFactory,
            TargetFilterQueryManagement targetFilterQueryManagement, QuotaManagement quotaManagement,
