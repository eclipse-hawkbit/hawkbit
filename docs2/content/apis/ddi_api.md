...
For historical reasons the DDI has a different state machine and status messages than the [Target State Machine](../architecture/targetstate.html) of the hawkBit update server.
...
[--> RESTdocs documentation](rest-api/rootcontroller-api-guide.html)
