 ...
 */
public final class SoftwareMouleJsonMatcher extends BaseMatcher<Set<SoftwareModule>> {

    private final List<org.eclipse.hawkbit.dmf.json.model.SoftwareModule> expectedModules;

    private SoftwareMouleJsonMatcher(List<org.eclipse.hawkbit.dmf.json.model.SoftwareModule> expectedModules) {
     ...
     */
    @Factory
    public static Matcher<Set<SoftwareModule>> containsExactly(
            final List<org.eclipse.hawkbit.dmf.json.model.SoftwareModule> expectedModules) {
        return new SoftwareMouleJsonMatcher(expectedModules);
    }

    private static boolean containsExactly(Object actual,
