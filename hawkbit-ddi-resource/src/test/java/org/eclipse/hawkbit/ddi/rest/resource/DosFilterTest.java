...
public class DosFilterTest extends AbstractDDiApiIntegrationTest {
    ...
    private Long prepareDeploymentBase() {
        ...
        assertThat(deploymentManagement.findActiveActionsByTarget(pageReq, target.getControllerId())).hasSize(1);

        final Action uaction = deploymentManagement.findActiveActionsByTarget(pageReq, target.getControllerId())
                .getContent().get(0);
