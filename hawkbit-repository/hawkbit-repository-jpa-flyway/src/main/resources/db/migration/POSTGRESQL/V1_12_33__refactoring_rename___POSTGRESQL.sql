...
alter table sp_distribution_set rename constraint uk_distrib_set_sp_distribution_set to uk_sp_distribution_set;
alter table sp_distribution_set rename constraint fk_ds_dstype_ds to fk_distribution_set_ds_type;
alter table sp_distribution_set_tag rename constraint uk_ds_tag_sp_distributionset_tag to uk_sp_distribution_set_tag;
alter table sp_distribution_set_type rename constraint uk_dst_key_sp_distribution_set_type to uk_sp_distribution_set_type_type_key;
alter table sp_distribution_set_type rename constraint uk_dst_name_sp_distribution_set_type to uk_sp_distribution_set_type_name;
...
alter table sp_rollout rename constraint uk_rollout_sp_rollout to uk_sp_rollout;
alter table sp_rollout rename constraint fk_rollout_ds to fk_rollout_distribution_set;
alter table sp_rollout_group rename constraint uk_rolloutgroup_sp_rolloutgroup to uk_sp_rollout_group;
...
alter table sp_software_module rename constraint uk_base_sw_mod_sp_base_software_module to uk_sp_software_module;
alter table sp_software_module rename constraint fk_module_type to fk_software_module_sm_type;
alter table sp_software_module_type rename constraint uk_smt_type_key_sp_software_module_type to uk_sp_software_module_type_type_key;
alter table sp_software_module_type rename constraint uk_smt_name_sp_software_module_type to uk_sp_software_module_type_name;
alter table sp_target_attributes rename constraint fk_targ_attrib_target to fk_target_attributes_target;
alter table sp_target_filter_query rename constraint uk_tenant_custom_filter_name_sp_target_filter_query to uk_sp_target_filter_query;
...
alter table sp_target_tag rename constraint uk_targ_tag_sp_target_tag to uk_sp_target_tag;
...
alter table sp_target_type rename constraint uk_target_type_key to uk_sp_target_type_key;
alter table sp_target_type rename constraint uk_target_type_name to uk_sp_target_name;
...
alter table sp_tenant rename constraint uk_tenantmd_tenant_sp_tenant to uk_sp_tenant;
alter table sp_tenant rename constraint  fk_tenant_md_default_ds_type to fk_sp_tenant_default_ds_type;
alter table sp_tenant_configuration rename constraint uk_tenant_key_sp_tenant_configuration to uk_sp_tenant_configuration;
-- rename primary keys
alter table sp_distribution_set_tag rename constraint pk_sp_distributionset_tag to pk_sp_distribution_set_tag;
alter table sp_ds_tag rename constraint pk_sp_ds_dstag to pk_sp_ds_tag;
alter table sp_sm_metadata rename constraint pk_sp_sw_metadata to pk_sp_sm_metadata;
alter table sp_software_module rename constraint pk_sp_base_software_module to pk_sp_software_module;
alter table sp_rollout_group rename constraint pk_sp_rolloutgroup to pk_sp_rollout_group;
alter table sp_rollout_target_group rename constraint pk_sp_rollouttargetgroup to pk_sp_rollout_target_group;
-- rename indexes
