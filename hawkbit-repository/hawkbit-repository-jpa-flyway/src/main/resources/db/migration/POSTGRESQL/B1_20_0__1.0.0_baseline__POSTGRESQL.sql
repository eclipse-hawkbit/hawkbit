...
ALTER TABLE ONLY sp_action
    ADD CONSTRAINT fk_action_distribution_set FOREIGN KEY (distribution_set) REFERENCES sp_distribution_set(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY sp_action
    ADD CONSTRAINT fk_action_rollout FOREIGN KEY (rollout) REFERENCES sp_rollout(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY sp_action
    ADD CONSTRAINT fk_action_rollout_group FOREIGN KEY (rollout_group) REFERENCES sp_rollout_group(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY sp_action_status
    ADD CONSTRAINT fk_action_status_action FOREIGN KEY (action) REFERENCES sp_action(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_action_status_messages
    ADD CONSTRAINT fk_action_status_messages_action_status FOREIGN KEY (action_status) REFERENCES sp_action_status(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_action
    ADD CONSTRAINT fk_action_target FOREIGN KEY (target) REFERENCES sp_target(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_artifact
    ADD CONSTRAINT fk_artifact_software_module FOREIGN KEY (software_module) REFERENCES sp_software_module(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_distribution_set
    ADD CONSTRAINT fk_distribution_set_ds_type FOREIGN KEY (ds_type) REFERENCES sp_distribution_set_type(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY sp_ds_metadata
    ADD CONSTRAINT fk_ds_metadata_ds FOREIGN KEY (ds) REFERENCES sp_distribution_set(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_ds_sm
    ADD CONSTRAINT fk_ds_sm_ds_id FOREIGN KEY (ds_id) REFERENCES sp_distribution_set(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_ds_sm
    ADD CONSTRAINT fk_ds_sm_sm_id FOREIGN KEY (sm_id) REFERENCES sp_software_module(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_ds_tag
    ADD CONSTRAINT fk_ds_tag_ds FOREIGN KEY (ds) REFERENCES sp_distribution_set(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_ds_tag
    ADD CONSTRAINT fk_ds_tag_tag FOREIGN KEY (tag) REFERENCES sp_distribution_set_tag(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_ds_type_element
    ADD CONSTRAINT fk_ds_type_element_distribution_set_type FOREIGN KEY (distribution_set_type) REFERENCES sp_distribution_set_type(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_ds_type_element
    ADD CONSTRAINT fk_ds_type_element_software_module_type FOREIGN KEY (software_module_type) REFERENCES sp_software_module_type(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_rollout
    ADD CONSTRAINT fk_rollout_distribution_set FOREIGN KEY (distribution_set) REFERENCES sp_distribution_set(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY sp_rollout_group
    ADD CONSTRAINT fk_rollout_group_rollout FOREIGN KEY (rollout) REFERENCES sp_rollout(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_rollout_target_group
    ADD CONSTRAINT fk_rollout_target_group_rollout_group FOREIGN KEY (rollout_group) REFERENCES sp_rollout_group(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_rollout_target_group
    ADD CONSTRAINT fk_rollout_target_group_target FOREIGN KEY (target) REFERENCES sp_target(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_sm_metadata
    ADD CONSTRAINT fk_sm_metadata_sm FOREIGN KEY (sm) REFERENCES sp_software_module(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_software_module
    ADD CONSTRAINT fk_software_module_sm_type FOREIGN KEY (sm_type) REFERENCES sp_software_module_type(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY sp_tenant
    ADD CONSTRAINT fk_sp_tenant_default_ds_type FOREIGN KEY (default_ds_type) REFERENCES sp_distribution_set_type(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY sp_target
    ADD CONSTRAINT fk_target_assign_ds FOREIGN KEY (assigned_distribution_set) REFERENCES sp_distribution_set(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY sp_target_attributes
    ADD CONSTRAINT fk_target_attributes_target FOREIGN KEY (target) REFERENCES sp_target(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_target_filter_query
    ADD CONSTRAINT fk_target_filter_query_auto_assign_distribution_set FOREIGN KEY (auto_assign_distribution_set) REFERENCES sp_distribution_set(id) ON
UPDATE RESTRICT
ON
DELETE
SET NULL;
...
ALTER TABLE ONLY sp_target
    ADD CONSTRAINT fk_target_inst_ds FOREIGN KEY (installed_distribution_set) REFERENCES sp_distribution_set(id) ON
UPDATE RESTRICT
ON
DELETE
RESTRICT;
...
ALTER TABLE ONLY sp_target_metadata
    ADD CONSTRAINT fk_target_metadata_target FOREIGN KEY (target) REFERENCES sp_target(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_target
    ADD CONSTRAINT fk_target_relation_target_type FOREIGN KEY (target_type) REFERENCES sp_target_type(id) ON
UPDATE RESTRICT
ON
DELETE
SET NULL;
...
ALTER TABLE ONLY sp_target_target_tag
    ADD CONSTRAINT fk_target_target_tag_tag FOREIGN KEY (tag) REFERENCES sp_target_tag(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_target_target_tag
    ADD CONSTRAINT fk_target_target_tag_target FOREIGN KEY (target) REFERENCES sp_target(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_target_type_ds_type
    ADD CONSTRAINT fk_target_type_ds_type_distribution_set_type FOREIGN KEY (distribution_set_type) REFERENCES sp_distribution_set_type(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;
...
ALTER TABLE ONLY sp_target_type_ds_type
    ADD CONSTRAINT fk_target_type_ds_type_target_type FOREIGN KEY (target_type) REFERENCES sp_target_type(id) ON
UPDATE RESTRICT
ON
DELETE
CASCADE;