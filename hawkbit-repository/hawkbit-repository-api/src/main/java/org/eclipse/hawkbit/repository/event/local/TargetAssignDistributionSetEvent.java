 ...
 *
 */
public class TargetAssignDistributionSetEvent extends LocalTenantAwareEvent {
     ...
     */
    public TargetAssignDistributionSetEvent(final String tenant, final Target target, final Long actionId,
            final Collection<SoftwareModule> softwareModules) {
        super(tenant);
        this.target = target;
