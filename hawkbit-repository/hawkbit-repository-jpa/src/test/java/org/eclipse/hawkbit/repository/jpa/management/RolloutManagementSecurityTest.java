...
class RolloutManagementSecurityTest extends AbstractJpaIntegrationTest {
    ...
    void createPermissionsCheck() {
        ...
        assertPermissions(() -> rolloutManagement.create(Create.builder()
                        .distributionSet(ds).build(), 1, false,
                new RolloutGroupConditionBuilder().withDefaults().build()), List.of(SpPermission.CREATE_ROLLOUT, SpPermission.READ_REPOSITORY));
        assertPermissions(() -> rolloutManagement.create(Create.builder().distributionSet(ds).build(), 1, false,
        ...
        assertPermissions(
                () -> rolloutManagement.create(Create.builder().distributionSet(ds).build(),
                        List.of(GroupCreate.builder().build()),
