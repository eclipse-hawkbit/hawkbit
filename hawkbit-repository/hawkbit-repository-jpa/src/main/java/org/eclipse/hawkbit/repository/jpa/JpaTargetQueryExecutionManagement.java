...
public class JpaTargetQueryExecutionManagement implements TargetQueryExecutionManagement {
    ...
    @Override
    public Page<? extends Target> findAll(@NotNull final Pageable pageable) {
        return targetRepository.findAll(pageable);
    }

    @Override
    public Page<? extends Target> findByQuery(final Pageable pageable, @NotEmpty final String query) {
        return targetRepository.findAll(toSpec(query), pageable);
    }

    @Override
    public Page<? extends Target> findByQuery(@NotNull final Pageable pageable, @NotEmpty final String query,
